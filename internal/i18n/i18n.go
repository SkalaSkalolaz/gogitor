...
var messages = map[Lang]map[string]string{
	...
	RU: map[string]string{
        "Running Agent Deep quality gates":
        	"Выполнение quality gates Agent Deep",
        
        "Agent session artifacts: %s":
        	"Артефакты сессии Agent: %s",
        
        "Analyzing agent artifacts: %s":
        	"Анализ артефактов Agent: %s",
        
        "Generating agent reflection...":
        	"Формирование ретроспективы Agent...",
        
        "Reflection saved: %s":
        	"Ретроспектива сохранена: %s",
        
        "no agent session found: %v":
        	"Сессия Agent не найдена: %v",
        ...
        "usage: :load <path/to/file.txt|file.md>":
        	"использование: :load <путь/к/файлу.txt|файл.md>",
        
        "Task loaded from file: %s":
        	"Задача загружена из файла: %s",
        
        "cannot read task file: %w":
        	"не удалось прочитать файл задачи: %w",
        
        "task file path is a directory: %s":
        	"путь к файлу задачи является директорией: %s",
        
        "task file must have .txt or .md extension: %s":
        	"файл задачи должен иметь расширение .txt или .md: %s",
        
        "task file is too large (%d bytes), max %d bytes":
        	"файл задачи слишком большой (%d байт), максимум %d байт",
        
        "task file is empty: %s":
        	"файл задачи пуст: %s",
...
"%s / %s | Enter send | Alt+Enter newline | Ctrl+A copy | PgUp/PgDn history | F2: select | Ctrl+C quit":
        ...
        "Autonomy monitor started.":
            "Монитор автономии запущен.",
        "Autonomy monitor stopped.":
            "Монитор автономии остановлен.",
        "Autonomy queue cleared.":
            "Очередь автономии очищена.",
        "Autonomy queue is empty. No pending tasks.":
            "Очередь автономии пуста. Нет ожидающих задач.",
        "usage: :autonomy [on|off|status|run|clear]":
        ...
        "⚠ go vet: issues found":
            "⚠ go vet: обнаружены замечания",
        
        // ─── Autonomy: mutate ─────────────────────────────────────────
        "## Mutation Testing Report":
            "## Отчёт мутационного тестирования",
        "No mutations were tested (no applicable operators found or all errors).":
            "Мутации не тестировались (не найдено применимых операторов или все ошибки).",
        "### ✗ Survived mutations (weak tests)":
            "### ✗ Выжившие мутации (слабые тесты)",
        "### ✓ Killed mutations (strong tests)":
            "### ✓ Убитые мутации (сильные тесты)",
        "### ⚠ Errors":
            "### ⚠ Ошибки",
        
        // ─── Autonomy: test generation ────────────────────────────────
        "## Untested Exported Functions":
            "## Экспортированные функции без тестов",
        "Use `:autogen-tests` to generate tests for these functions.":
            "Используйте `:autogen-tests` для генерации тестов для этих функций.",
        "## Test Generation Results":
            "## Результаты генерации тестов",
        
        // ─── Autonomy: queue ──────────────────────────────────────────
        "Use `:autonomy run` to execute fixable tasks.":
            "Используйте `:autonomy run` для выполнения исправляемых задач.",
        
        // ─── Autonomy: commands ───────────────────────────────────────
        "Generating mutations (deterministic, no LLM)...":
            "Генерация мутаций (детерминированно, без LLM)...",
        "Generating test file":
            "Генерация файла теста",
        "No applicable mutations found.":
            "Применимые мутации не найдены.",
        "No untested exported functions found.":
            "Экспортированные функции без тестов не найдены.",
	},
}
